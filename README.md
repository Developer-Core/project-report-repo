...
| 17    | HU16          | Selección de tipo de usuario                    | Como usuario, quiero definir si soy carpintero o cliente para acceder a funcionalidades específicas.                     | 2            |
| 18    | HU13          | Registro de usuario                             | Como visitante, quiero registrarme en la plataforma para poder acceder a sus funcionalidades.                            | 3            |
| 19    | HU14          | Inicio de sesión                                | Como usuario registrado, quiero iniciar sesión en la plataforma para acceder a mi cuenta.                                | 2            |
| 20    | HU26          | Registro de materiales                          | Como carpintero, quiero registrar los materiales disponibles para llevar un control del inventario.                      | 3            |
| 21    | HU27          | Actualización de inventario                     | Como carpintero, quiero actualizar las cantidades de materiales para reflejar el consumo o reposición.                   | 3            |
| 22    | HU28          | Validación de materiales para pedidos           | Como carpintero, quiero validar si tengo materiales suficientes para aceptar un pedido.                                  | 5            |
| 23    | HU29          | Alerta de bajo inventario                       | Como carpintero, quiero recibir alertas cuando el stock sea bajo para evitar retrasos en producción.                     | 5            |
| 24    | HU30          | Cálculo de costo estimado                       | Como carpintero, quiero calcular el costo estimado de un pedido para definir un precio adecuado.                         | 5            |
| 25    | HU25          | Estimación de tiempos por etapa                 | Como carpintero, quiero asignar tiempos estimados a cada etapa para planificar mejor la entrega.                         | 5            |
| 26    | HU31          | Estimación de tiempo total                      | Como carpintero, quiero estimar el tiempo total de fabricación para planificar la entrega del pedido.                    | 5            |
| 27    | HU33          | Generación de presupuesto                       | Como carpintero, quiero generar un presupuesto para presentar al cliente antes de iniciar el trabajo.                    | 5            |
| 28    | HU32          | Evaluación de rentabilidad                      | Como carpintero, quiero evaluar la rentabilidad de un pedido para tomar decisiones informadas.                           | 5            |
| 29    | HU20          | Modificación de pedido                          | Como cliente, quiero modificar un pedido antes de que sea aceptado para ajustar los detalles.                            | 3            |
| 30    | HU21          | Cancelación de pedido                           | Como cliente, quiero cancelar un pedido para detener el proceso si ya no lo necesito.                                    | 2            |
| 31    | HU43          | Consulta pública del estado del pedido          | Como cliente, quiero consultar el estado de mi pedido mediante un enlace público sin necesidad de iniciar sesión.        | 3            |
| 32    | HU34          | Envío de mensajes                               | Como usuario, quiero enviar mensajes dentro de la plataforma para comunicarme sobre el pedido.                           | 3            |
| 33    | HU35          | Recepción de mensajes                           | Como usuario, quiero recibir mensajes para mantenerme informado sobre el pedido.                                         | 3            |
| 34    | HU36          | Historial de comunicación                       | Como usuario, quiero ver el historial de mensajes para revisar conversaciones anteriores.                                | 2            |
...
| 39    | HU44          | Generación de orden de compra al proveedor      | Como carpintero, quiero generar una orden de compra a un proveedor de madera para reponer el inventario.                 | 5            |
| 40    | HU40          | Solicitud de pago final                         | Como carpintero, quiero emitir una solicitud de pago final al cliente cuando el mueble esté listo para entrega.          | 2            |
| 41    | HU41          | Registro de comprobante de pago final           | Como cliente, quiero registrar el comprobante del pago final para coordinar la entrega de mi mueble.                     | 3            |
