...
|------|--------|-------------|-------------|-------------|
| HU01 | Navegación entre secciones de la landing | Como visitante, quiero navegar entre las secciones de Features, How it Works y Pricing desde el menú superior para explorar la información de WoodRoute sin recargar la página. | **Escenario 1: Click en link del menú** <br> _Dado_ que el visitante se encuentra en la landing <br> _Cuando_ hace click en un link del menú (Features, How it works o Pricing) <br> _Entonces_ la página realiza scroll suave a la sección correspondiente <br> _Y_ la URL refleja el ancla de la sección | EP01 |
| HU02 | Visualización de propuesta de valor en hero carrusel | Como visitante, quiero ver una propuesta de valor en un carrusel destacado al inicio de la landing para entender rápidamente qué problema resuelve WoodRoute. | **Escenario 1: Visualización del carrusel** <br> _Dado_ que el visitante accede a la landing <br> _Cuando_ se carga la página <br> _Entonces_ se muestra un carrusel con 4 slides describiendo la propuesta de valor <br> _Y_ el visitante puede navegar entre slides con las flechas previo y siguiente | EP01 |
| HU03 | Visualización de funcionalidades (Features) | Como visitante, quiero ver una sección de Features con las principales capacidades de WoodRoute para entender qué puedo hacer con la plataforma. | **Escenario 1: Visualización de funcionalidades** <br> _Dado_ que el visitante navega a la sección Features <br> _Cuando_ la sección está visible <br> _Entonces_ se muestran las funcionalidades clave (gestión de pedidos, asistente de viabilidad, control de inventario, seguimiento en tiempo real) con su descripción | EP01 |
| HU04 | Explicación del flujo de uso (How it works) | Como visitante, quiero entender cómo se usa WoodRoute en pasos claros para evaluar si se ajusta a mi flujo de trabajo. | **Escenario 1: Visualización del flujo** <br> _Dado_ que el visitante navega a la sección How it works <br> _Cuando_ la sección está visible <br> _Entonces_ se muestran los pasos del flujo (registrarse, crear pedido, seguir progreso, recibir mueble) <br> _Y_ cada paso incluye una breve descripción | EP01 |
| HU05 | Visualización de planes de precios (Pricing) | Como visitante, quiero ver los planes de precios disponibles para evaluar cuál se ajusta a mi taller antes de registrarme. | **Escenario 1: Visualización de planes** <br> _Dado_ que el visitante navega a la sección Pricing <br> _Cuando_ la sección está visible <br> _Entonces_ se muestran los planes (Free, Pro, Business) con sus precios y características <br> _Y_ cada plan incluye un CTA para empezar | EP01 |
| HU06 | CTA segmentado hacia la Web Application | Como visitante (carpintero o cliente), quiero que el CTA principal del Landing me redirija a la vista correspondiente de la Web Application según mi segmento, para empezar a usar la plataforma rápidamente. | **Escenario 1: CTA carpintero** <br> _Dado_ que el visitante es un carpintero <br> _Cuando_ hace click en el CTA "Empezar como carpintero" <br> _Entonces_ el navegador lo redirige a la vista de registro de la Web App con el rol carpintero pre-seleccionado <br><br> **Escenario 2: CTA cliente** <br> _Dado_ que el visitante es un cliente <br> _Cuando_ hace click en el CTA "Empezar como cliente" <br> _Entonces_ el navegador lo redirige a la vista de registro de la Web App con el rol cliente pre-seleccionado | EP01 |
| HU07 | Visualización del equipo (Team) | Como visitante, quiero ver los miembros del equipo detrás de WoodRoute para conocer quiénes desarrollan la plataforma. | **Escenario 1: Visualización del equipo** <br> _Dado_ que el visitante accede a la sección Team <br> _Cuando_ la sección está visible <br> _Entonces_ se muestran las fotos y nombres de los integrantes del equipo | EP01 |
| HU08 | Video About-the-Product embebido | Como visitante, quiero ver un video About-the-Product embebido en la landing para conocer las características principales del producto explicadas por el equipo. | **Escenario 1: Reproducción del video** <br> _Dado_ que el visitante accede a la sección About-the-Product <br> _Cuando_ hace click en el botón de reproducción del video embebido desde YouTube <br> _Entonces_ el video se reproduce dentro de la landing <br> _Y_ muestra las características principales del producto | EP01 |
| HU09 | Video About-the-Team embebido | Como visitante, quiero ver un video About-the-Team embebido en la landing para conocer al equipo y el proceso detrás del producto. | **Escenario 1: Reproducción del video** <br> _Dado_ que el visitante accede a la sección About-the-Team <br> _Cuando_ hace click en el botón de reproducción del video embebido desde YouTube <br> _Entonces_ el video se reproduce dentro de la landing <br> _Y_ muestra al equipo presentando su proceso y testimonios | EP01 |
| HU10 | Cambio de idioma EN ↔ ES | Como visitante, quiero cambiar el idioma de la landing entre English (default) y Latin American Spanish para leer el contenido en mi idioma preferido. | **Escenario 1: Idioma por defecto** <br> _Dado_ que un visitante accede por primera vez a la landing <br> _Cuando_ el navegador no tiene preferencia de idioma guardada <br> _Entonces_ el idioma por defecto es inglés (en_US) <br><br> **Escenario 2: Switch EN → ES** <br> _Dado_ que el visitante está en la landing en inglés <br> _Cuando_ selecciona el idioma "ES" en el selector <br> _Entonces_ todos los textos de la página se traducen al español (es_419) <br> _Y_ la preferencia de idioma se mantiene durante la navegación entre secciones | EP01 |
| HU11 | Acceso a Términos y Condiciones desde el footer | Como visitante, quiero acceder a los Términos y Condiciones del servicio desde un enlace en el footer para entender las condiciones de uso antes de registrarme. | **Escenario 1: Acceso a Términos y Condiciones** <br> _Dado_ que el visitante está en la landing <br> _Cuando_ hace click en el enlace "Términos y Condiciones" del footer <br> _Entonces_ se abre la página con los términos del servicio <br> _Y_ se muestra el contenido completo (responsabilidad ética y profesional según ACM/IEEE/CIP) | EP01 |
| HU12 | Acceso a redes sociales desde el footer | Como visitante, quiero acceder a las redes sociales de WoodRoute desde el footer para seguir las novedades de la marca. | **Escenario 1: Click en red social** <br> _Dado_ que el visitante está en la landing <br> _Cuando_ hace click en un ícono de red social en el footer <br> _Entonces_ se abre la red social correspondiente en una nueva pestaña | EP01 |
...
| ----- | ------------- | ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ------------ |
| 1     | HU01          | Navegación entre secciones de la landing        | Como visitante, quiero navegar entre Features, How it works y Pricing desde el menú superior sin recargar la página.     | 1            |
| 2     | HU02          | Hero carrusel con propuesta de valor            | Como visitante, quiero ver un carrusel con la propuesta de valor de WoodRoute al inicio de la landing.                   | 2            |
| 3     | HU03          | Visualización de funcionalidades (Features)     | Como visitante, quiero ver las funcionalidades clave de WoodRoute para entender qué puedo hacer con la plataforma.       | 1            |
| 4     | HU04          | Explicación del flujo de uso (How it works)     | Como visitante, quiero ver los pasos del flujo de uso para entender cómo funciona WoodRoute.                             | 1            |
| 5     | HU05          | Visualización de planes de precios (Pricing)    | Como visitante, quiero ver los planes de precios disponibles para evaluar cuál se ajusta a mi taller.                    | 2            |
| 6     | HU07          | Visualización del equipo (Team)                 | Como visitante, quiero ver los miembros del equipo detrás de WoodRoute.                                                  | 1            |
| 7     | HU12          | Acceso a redes sociales desde el footer         | Como visitante, quiero acceder a las redes sociales de WoodRoute desde el footer.                                        | 1            |
| 8     | HU11          | Acceso a Términos y Condiciones desde el footer | Como visitante, quiero acceder a los Términos y Condiciones del servicio desde un enlace en el footer.                   | 1            |
| 9     | HU06          | CTA segmentado hacia la Web Application         | Como visitante (carpintero o cliente), quiero que el CTA me redirija a la vista correspondiente de la Web App.           | 3            |
| 10    | HU08          | Video About-the-Product embebido                | Como visitante, quiero ver un video About-the-Product embebido en la landing para conocer el producto.                   | 2            |
| 11    | HU09          | Video About-the-Team embebido                   | Como visitante, quiero ver un video About-the-Team embebido en la landing para conocer al equipo.                        | 2            |
| 12    | HU10          | Cambio de idioma EN ↔ ES                        | Como visitante, quiero cambiar el idioma de la landing entre English (default) y Spanish.                                | 3            |
| 13    | HU17          | Creación de pedido personalizado                | Como cliente, quiero crear un pedido de mueble personalizado para solicitar un diseño específico.                        | 5            |
| 14    | HU19          | Aceptación o rechazo de pedidos                 | Como carpintero, quiero aceptar o rechazar pedidos para gestionar mi carga de trabajo.                                   | 3            |
| 15    | HU18          | Visualización de pedidos                        | Como usuario, quiero visualizar la lista de pedidos para hacer seguimiento a su estado.                                  | 3            |
| 16    | HU24          | Visualización del progreso                      | Como cliente, quiero ver el progreso de mi pedido para conocer en qué etapa se encuentra.                                | 3            |
| 17    | HU22          | Definición de etapas de producción              | Como carpintero, quiero definir las etapas de producción de un pedido para organizar mejor el trabajo.                   | 5            |
| 18    | HU23          | Actualización del estado de producción          | Como carpintero, quiero actualizar el estado de cada etapa para reflejar el progreso del pedido.                         | 3            |
| 19    | HU16          | Selección de tipo de usuario                    | Como usuario, quiero definir si soy carpintero o cliente para acceder a funcionalidades específicas.                     | 2            |
| 20    | HU13          | Registro de usuario                             | Como visitante, quiero registrarme en la plataforma para poder acceder a sus funcionalidades.                            | 3            |
| 21    | HU14          | Inicio de sesión                                | Como usuario registrado, quiero iniciar sesión en la plataforma para acceder a mi cuenta.                                | 2            |
...
| 27    | HU25          | Estimación de tiempos por etapa                 | Como carpintero, quiero asignar tiempos estimados a cada etapa para planificar mejor la entrega.                         | 5            |
| 28    | HU31          | Estimación de tiempo total                      | Como carpintero, quiero estimar el tiempo total de fabricación para planificar la entrega del pedido.                    | 5            |
| 29    | HU33          | Generación de presupuesto                       | Como carpintero, quiero generar un presupuesto para presentar al cliente antes de iniciar el trabajo.                    | 5            |
| 30    | HU32          | Evaluación de rentabilidad                      | Como carpintero, quiero evaluar la rentabilidad de un pedido para tomar decisiones informadas.                           | 5            |
| 31    | HU20          | Modificación de pedido                          | Como cliente, quiero modificar un pedido antes de que sea aceptado para ajustar los detalles.                            | 3            |
| 32    | HU21          | Cancelación de pedido                           | Como cliente, quiero cancelar un pedido para detener el proceso si ya no lo necesito.                                    | 2            |
| 33    | HU43          | Consulta pública del estado del pedido          | Como cliente, quiero consultar el estado de mi pedido mediante un enlace público sin necesidad de iniciar sesión.        | 3            |
| 34    | HU34          | Envío de mensajes                               | Como usuario, quiero enviar mensajes dentro de la plataforma para comunicarme sobre el pedido.                           | 3            |
| 35    | HU35          | Recepción de mensajes                           | Como usuario, quiero recibir mensajes para mantenerme informado sobre el pedido.                                         | 3            |
| 36    | HU36          | Historial de comunicación                       | Como usuario, quiero ver el historial de mensajes para revisar conversaciones anteriores.                                | 2            |
| 37    | HU15          | Gestión de perfil                               | Como usuario, quiero editar mi información personal para mantener mis datos actualizados.                                | 3            |
| 38    | HU37          | Aceptación del presupuesto por el cliente       | Como cliente, quiero aceptar el presupuesto generado por el carpintero para confirmar el costo y los tiempos.            | 2            |
| 39    | HU38          | Registro de comprobante de anticipo             | Como cliente, quiero registrar el comprobante de mi anticipo de pago para que el carpintero inicie la producción.        | 3            |
| 40    | HU39          | Validación de anticipo por el carpintero        | Como carpintero, quiero validar el comprobante del anticipo para autorizar el inicio de la producción.                   | 3            |
| 41    | HU44          | Generación de orden de compra al proveedor      | Como carpintero, quiero generar una orden de compra a un proveedor de madera para reponer el inventario.                 | 5            |
| 42    | HU40          | Solicitud de pago final                         | Como carpintero, quiero emitir una solicitud de pago final al cliente cuando el mueble esté listo para entrega.          | 2            |
| 43    | HU41          | Registro de comprobante de pago final           | Como cliente, quiero registrar el comprobante del pago final para coordinar la entrega de mi mueble.                     | 3            |
| 44    | HU42          | Validación de pago final                        | Como carpintero, quiero validar el comprobante del pago final para autorizar la entrega del mueble.                      | 3            |
