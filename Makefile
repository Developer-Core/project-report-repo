...
$(README): $(MD_FILES)
	@cat $(MD_FILES) | sed 's/ *{[^}]*}//g' | sed '/<div class="page-break"><\/div>/d' | sed 's|src="assets/|src="report/assets/|g' | sed 's|src="annexes/|src="report/annexes/|g' | sed 's|](assets/|](report/assets/|g' | sed 's|](annexes/|](report/annexes/|g' > $(README)
